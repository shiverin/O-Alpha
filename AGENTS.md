...
- For code changes, follow `docs/TEST_STRATEGY.md`: choose the lowest useful test tier,
  keep backend/frontend unit tests fast, and reserve integration/system/live checks for the
  environments and build tags documented there.
