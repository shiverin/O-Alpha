...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    fetchAndCheckRegistrationPosture();
  }, [currentUserID]);
      ...
      <div className="w-full bg-transparent flex flex-col gap-6 md:gap-10 animate-in fade-in duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start">
          ...
          <div className="md:col-span-12 xl:col-span-8 group relative flex flex-col h-auto min-h-[380px] sm:h-[460px] bg-surface-container-low border border-outline-variant/30 rounded-[32px] p-5 sm:p-8 overflow-hidden hover:bg-surface-container transition-all duration-700 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
            ...
            <div className="flex justify-between items-center mb-6 sm:mb-8 border-b border-outline-variant/20 pb-4 relative z-10">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-medium tracking-[0.2em] text-on-surface uppercase">Agent Status: {isAgentActive ? "Optimising" : "Idle"}</span>
              </div>
              <span className="px-2.5 py-0.5 bg-white/[0.02] border border-outline-variant/30 rounded-full text-[9px] font-medium tracking-widest text-secondary-fixed">REGIME: VOLATILE</span>
            </div>
          ...
          <div className="md:col-span-12 group relative flex flex-col h-[380px] bg-surface-container-low border border-outline-variant/30 rounded-[32px] p-5 sm:p-8 overflow-hidden hover:bg-surface-container transition-all duration-700 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
            <h3 className="text-[10px] font-medium tracking-[0.2em] text-on-surface uppercase mb-5 flex items-center gap-2"><span className="material-symbols-outlined text-[16px] text-on-surface-variant">terminal</span>Live Execution Log</h3>
          ...
          {/* PORTFOLIO ALLOCATION DOCK CHART */}
          <div className="md:col-span-12 group relative flex flex-col h-auto md:h-[380px] bg-surface-container-low border border-outline-variant/30 rounded-[32px] p-5 sm:p-8 overflow-hidden hover:bg-surface-container transition-all duration-700 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
            <h3 className="text-[10px] font-medium tracking-[0.2em] text-on-surface uppercase mb-6">Portfolio Allocation</h3>
            <div className="flex-grow flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 h-full py-4 sm:py-0">
              <div className="relative w-36 h-36 sm:w-40 sm:h-40 shrink-0 flex items-center justify-center">
                <svg className="absolute inset-0 transform -rotate-90" viewBox="0 0 100 100">
                  ...
                  <circle cx="50" cy="50" r="40" fill="transparent" stroke="#00f0ff" strokeWidth="12" strokeDasharray="251.2" strokeDashoffset="150.72" strokeLinecap="round" style={{ filter: "drop-shadow(0 0 6px rgba(0,240,255,0.3))" }} />
                  <circle cx="50" cy="50" r="40" fill="transparent" stroke="#ffd700" strokeWidth="12" strokeDasharray="251.2" strokeDashoffset="175.84" strokeLinecap="round" style={{ filter: "drop-shadow(0 0 6px rgba(255,215,0,0.2))" }} transform="rotate(144 50 50)" />
                </svg>
