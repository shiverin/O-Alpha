        ...
        {step === 1 && (
          <div className="flex flex-col items-center text-center py-10 max-w-2xl mx-auto">
            <div className="h-16 w-16 rounded-2xl flex items-center justify-center mb-8 bg-white/[0.02] border border-outline-variant/20">
              <span className="material-symbols-outlined text-primary-fixed-dim text-3xl animate-pulse">
                token
              </span>
            </div>
            ...
            <p className="text-sm sm:text-base font-light text-on-surface-variant/70 leading-relaxed mb-10">
              Deploy your quant-level autonomous agent infrastructure.
              Initialize corporate engine posture metrics below to open up your
              telemetry overview terminal.
            </p>
            <button
              onClick={() => setStep(2)}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center border-t border-outline-variant/10 pt-6 gap-4">
              <div className="flex gap-4 w-full sm:w-auto ml-auto">
                <button
                  onClick={() => setStep(1)}
                  disabled={isSaving}
                  className="flex-1 sm:flex-none px-6 py-2.5 border border-outline-variant/30 text-on-surface-variant font-mono text-xs tracking-wider uppercase rounded-full hover:text-on-surface transition-colors"
                >
                  Back
                </button>
                <button
                  ...
                  disabled={isSaving}
                  className="flex-1 sm:flex-none px-8 py-2.5 bg-primary-container text-void-black font-mono font-medium text-xs tracking-wider uppercase rounded-full disabled:opacity-50 flex items-center justify-center gap-2 shadow-md"
                >
